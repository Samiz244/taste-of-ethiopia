const dishes = [
  {
    id: "doro-wat",
    name: "Doro Wat",
    description: "A rich and spicy chicken stew that is one of Ethiopia's most iconic dishes.",
  ...
  },
  {
    id: "kitfo",
    name: "Kitfo",
    description: "Finely minced beef seasoned with spiced butter and traditional spices.",
  ...
  },
  {
    id: "shiro",
    name: "Shiro",
    description: "A flavorful stew made from powdered chickpeas and spices.",
  ...
  },
  {
    id: "tibs",
    name: "Tibs",
    description: "Sautéed meat cooked with onions, peppers, and traditional seasonings.",
  ...
  },
  {
    id: "beyaynetu",
    name: "Beyaynetu",
    description: "A vegetarian platter featuring a variety of vegetable and legume dishes served on injera.",
